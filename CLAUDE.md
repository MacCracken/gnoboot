...
_TODO: one-or-two-sentence mission statement. What does gnoboot OWN in the stack? Durable — doesn't change per release._
...
cyrius build src/main.cyr build/gnoboot
